...
class Enterprise(TimeStampedModel, models.Model):
    ...
    house_number = models.IntegerField(
        verbose_name="Numero da casa", blank=True, null=True, help_text="Ex: 1"
    )
    ...
    iss_retained = models.BooleanField(
        verbose_name="Iss retido", default=False, null=True, blank=True
    )
    iss_value = models.DecimalField(
    ...
    iss_aliquot = models.DecimalField(
...
class Bill(TimeStampedModel, models.Model):
    ...
    apply_discount = models.BooleanField(verbose_name="aplicar desconto", default=False)
...
class Cashier(TimeStampedModel, models.Model):
    ...
    income_pix = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    income_credit = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    income_debit = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    income_cash = models.DecimalField(max_digits=10, decimal_places=2, default=0)

    expense_pix = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    expense_boleto = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    expense_automatic = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    expense_others = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    expense_withdrawal = models.DecimalField(max_digits=10, decimal_places=2, default=0)
