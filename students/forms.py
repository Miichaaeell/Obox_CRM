    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={
                    "class": "text-gray-700 w-full border-b border-gray-400 focus:outline-none"
                }
            ),
            "cpf_cnpj": forms.TextInput(
                attrs={
                    "class": "text-gray-700 w-32 border-b border-gray-400 focus:outline-none",
                    "help_text": "Ex. 12345678910",
                    "x-data": "",
            ...
            "plan": forms.Select(
                attrs={
                    "class": "text-gray-700 w-32 bg-transparent border-b border-gray-400 focus:outline-none",
                    "@change": "completeValue($event)",
                }
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "amount": forms.NumberInput(
                attrs={
                    "class": "w-full px-4 py-2 rounded-lg border border-gray-700 focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                }
            ),
